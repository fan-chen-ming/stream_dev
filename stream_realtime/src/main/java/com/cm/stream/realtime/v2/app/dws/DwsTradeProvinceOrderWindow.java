package com.cm.stream.realtime.v2.app.dws;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.cm.stream.realtime.v1.bean.TradeProvinceOrderBean;
import com.cm.stream.realtime.v1.constant.Constant;
import com.cm.stream.realtime.v1.function.BeanToJsonStrMapFunction;
import com.cm.stream.realtime.v1.utils.DateFormatUtil;
import com.cm.stream.realtime.v1.utils.FlinkSinkUtil;
import com.cm.stream.realtime.v1.utils.FlinkSourceUtil;
import com.cm.stream.realtime.v1.utils.HBaseUtil;
...
/**
 * @Package com.cm.stream.realtime.v1.app.dws.DwsTradeProvinceOrderWindow
 * @Author chen.ming
...
public class DwsTradeProvinceOrderWindow {
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> kafkaSource = FlinkSourceUtil.getKafkaSource("dwd_trade_order_detail_chenming", "dws_trade_province_order_window");
