...
import com.cm.stream.realtime.v1.bean.CartAddUuBean;
...
/**
 * @Package com.cm.stream.realtime.v1.app.dws.DwsTradeCartAddUuWindow
 * @Author chen.ming
 * @Date 2025/4/21 9:36
...
public class DwsTradeCartAddUuWindow {
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> kafkaSource = FlinkSourceUtil.getKafkaSource("dwd_trade_cart_add_chenming", "dws_trade_cart_add_uu_window");
