package com.cm.stream.realtime.v1.utils;
...
public class RedisUtil {
    ...
    static {
        ...
        String password = "zh1028,./";

        jedisPool = new JedisPool(jedisPoolConfig, "10.39.48.33", 6379 , 10000, password);
    }
    ...
    public static StatefulRedisConnection<String,String> getRedisAsyncConnection(){
        ...
        RedisClient redisClient = RedisClient.create("redis://10.39.48.33:6379/0");
