...
import com.cm.stream.realtime.v1.utils.JdbcUtil;
...
/**
 * @Package com.cm.stream.realtime.v1.function.TableProcessFunction
 * @Author chen.ming
 * @Date 2025/4/20 9:42
...
public class TableProcessFunction extends BroadcastProcessFunction<JSONObject, TableProcessDim, Tuple2<JSONObject,TableProcessDim>> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        List<TableProcessDim> tableProcessDimList = JdbcUtil.queryList(mySQLConnection, "select * from realtime_v1_config.table_process_dim", TableProcessDim.class, true);
